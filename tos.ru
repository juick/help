...
<ol>
  ...
  противоречит действующему законодательству Германии или нормам международного
  права.</li>
...
<h2>Фото и видео</h2>
<p>Функция загрузки медиа-файлов предназначена для фотографий и видео-роликов,
которые были сняты вами или на которых вы присутствуете.</p>
